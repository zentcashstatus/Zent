# USAGE: Start Zent-service as you usually would
...
from zentcash import Walletd as Wallet
import time
import argparse
parser = argparse.ArgumentParser()
parser.add_argument("--address", help="Zent Cash address to optimize", required=True)
parser.add_argument("--port", type=int, help="Wallet port", required=False, default=21699)
